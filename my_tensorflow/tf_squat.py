...
for image_path in image_paths:
   ...
   # Output is a [1, 1, 17, 3] tensor.
    ...
    hip_y = outputs_numpy[0][0][landmarks[dominant-side + ' hip']][0]
    knee_y = outputs_numpy[0][0][landmarks[dominant-side + ' knee']][0]
    
    hip_knee_y_dist = hip_y - knee_y
    if hip_knee_y_distance <= 0.1:
        is_full_squat = True
    elif hip_knee_y_distance < 0:
